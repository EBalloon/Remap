...
namespace kdmapper
{
	...
	uint64_t MapDriver(HANDLE iqvw64e_device_handle, unsigned char* driverRawdata, SIZE_T Size, ULONG64 param1 = 0, ULONG64 param2 = 0, bool free = false, bool destroyHeader = true, bool mdlMode = false, bool PassAllocationAddressAsFirstParam = false, mapCallback callback = nullptr, NTSTATUS* exitCode = nullptr);
